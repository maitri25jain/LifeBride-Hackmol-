...
import { useAuth } from '../../context/useAuth';import { useAuth } from '../../context/AuthContext';
        ...
        <div className="card">
          ...
          {mode === 'register' && step === 2 && (
            <form onSubmit={handleRegisterVerify} className="space-y-4 animate-fadeIn">
              ...
              >
                <span style={{ color: 'var(--green-400)' }}>
                  Verify your phone to complete registration. Demo OTP:{' '}
                  <span className="font-mono font-bold">123456</span>
                </span>
              </div>
              <div>
