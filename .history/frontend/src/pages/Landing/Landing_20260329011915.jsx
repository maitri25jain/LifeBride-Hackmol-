          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center">
                <div className="text-xs font-mono mb-3" style={{ color: 'var(--text-muted)' }}>{s.n}</div>
                <div className="text-lg font-bold font-display mb-2" style={{ color: 'var(--red-400)' }}>{s.t}</div>
