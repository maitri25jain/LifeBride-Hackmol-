...
const PILLARS = [
  {  title: 'Immutable Consent', desc: 'Soulbound ERC-5192 NFTs on Polygon lock donor pledges to Aadhaar-verified identities. Un-tamperable. Court-admissible.', accent: 'var(--blue-400)' },
