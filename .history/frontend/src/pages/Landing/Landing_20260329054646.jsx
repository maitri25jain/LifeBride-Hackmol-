...
const PILLARS = [
  ...
  {  title: 'AI Matching Engine', desc: 'Multi-variable scoring — ABO/HLA compatibility, cold ischemia viability clock, equity monitoring. No human bias.', accent: 'var(--red-400)' },
    ...
    <div className="min-h-screen overflow-hidden" style={{ background: 'var(--bg-deep)' }}>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-20">
        ...
        <div className="relative z-10 text-center max-w-4xl animate-fadeUp">
          ...
          <h1 className="text-4xl sm:text-7xl font-extrabold tracking-tight leading-[1.08] mb-6 font-display">
