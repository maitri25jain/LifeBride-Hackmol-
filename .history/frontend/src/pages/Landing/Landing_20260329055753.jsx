...
const STATS = [
  ...
  { value: '1 in 10', label: 'Pledges', sub: 'Gap in honoring upon death', color: 'var(--green-400)' },
];

const PILLARS = [
  {  title: 'Immutable Consent', desc: 'Soulbound ERC-5192 NFTs on Polygon lock donor pledges to Aadhaar-verified identities. Un-tamperable & Accountable.', accent: 'var(--blue-400)' },
  {  title: 'Scoring Engine', desc: 'Multi-variable scoring — ABO/HLA compatibility, cold ischemia viability clock, equity monitoring. No human bias.', accent: 'var(--red-400)' },
  {  title: 'Emergency Broadcast', desc: 'One-tap blood alerts to compatible donors within 10km. First three confirmed responders get hospital navigation instantly.', accent: 'var(--green-400)' },
];
    ...
    <div className="min-h-screen overflow-hidden" style={{ background: 'var(--bg-deep)' }}>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-20">
        ...
        <div className="relative z-10 text-center max-w-4xl animate-fadeUp">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold font-display mb-8" style={{ background: 'var(--green-glow)', color: 'var(--green-500)', border: '1px solid rgba(71, 219, 54, 0.25)' }}>
            <span className="w-2 h-2 rounded-full animate-pulse" style={{ background: 'var(--green-400)' }} />
            India's Secured Organ Pledge Network
          </div>
          ...
          <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tight leading-[1.08] mb-6 font-display">
            ...
            <span style={{ color: 'var(--red-400)' }}>LifeBridge</span> Connects.
          </h1>

          <p className="text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            LifeBridge is a decentralized life-saving network built on transparency and speed. We replace slow manual coordination 
            with Algorithm-driven organ matching, guarantee the integrity of your pledges, and mobilize nearby blood donors precisely when they are needed most.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/citizen/auth" className="btn-primary text-lg px-8 py-3.5 rounded-xl animate-pulse-glow">Mint My Pledge</Link>
            <Link to="/hospital/login" className="btn-secondary text-lg px-8 py-3.5 rounded-xl">For Hospital & OPOs</Link>
          </div>
        </div>
      ...
      <section className="py-28 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold font-display text-center mb-4">Eradicating Delays. Empowering Donors. Saving Lives.</h2>
      ...
      <section className="py-24 px-6" style={{ background: 'var(--bg-base)' }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-7xl font-bold font-display mb-16">The Flow</h2>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center">
                <div className="text-2xl font-mono mb-3" style={{ color: 'var(--text-muted)' }}>{s.n}</div>
                <div className="text-4xl font-bold font-display mb-2" style={{ color: 'var(--red-400)' }}>{s.t}</div>
      ...
      <section className="py-24 px-6 text-center">
        ...
        <p className="max-w-lg mx-auto mb-8" style={{ color: 'var(--text-secondary)' }}>
          Your organs, your blood, your decision!
        </p>
