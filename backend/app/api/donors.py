    ...
    for donor in donors:
        ...
        for organ in donor.get("organs_available", []):
            donor_organ_payload = {
                ...
                "donor_hospital_lat": hosp.get("location_lat", 28.6139),
                "donor_hospital_lon": hosp.get("location_lng", 77.2090),
                "donor_age":          donor["age"],
                "donor_weight":       donor.get("donor_weight") or 70.0,
                "donor_cause_of_death": donor.get("donor_cause_of_death"),
            }
...
def run_blood_match(
    ...
    for citizen in citizens:
        ...
        blood_donors_payload.append({
            ...
            "whatsapp_number":    citizen.get("phone"),
